...
namespace Physika {
    ...
    __device__ __forceinline__ void mat3::polarDecomposition(mat3& R)
    {
        mat3 W, S, V;

        svd(this->value[0], this->value[3], this->value[6], this->value[1], this->value[4], this->value[7], this->value[2], this->value[5], this->value[8], 
            W.value[0], W.value[3], W.value[6], W.value[1], W.value[4], W.value[7], W.value[2], W.value[5], W.value[8], 
            S.value[0], S.value[3], W.value[6], S.value[1], S.value[4], S.value[7], S.value[2], S.value[5], S.value[8], 
            V.value[0], V.value[3], V.value[6], V.value[1], V.value[4], V.value[7], V.value[2], V.value[5], V.value[8]);

        R.value[0] = W.value[0] * V.value[0] + W.value[3] * V.value[3] + W.value[6] * V.value[6];
        R.value[1] = W.value[1] * V.value[0] + W.value[4] * V.value[3] + W.value[7] * V.value[6];
        R.value[2] = W.value[2] * V.value[0] + W.value[5] * V.value[3] + W.value[8] * V.value[6];
        
        R.value[3] = W.value[0] * V.value[1] + W.value[3] * V.value[4] + W.value[6] * V.value[7];
        R.value[4] = W.value[1] * V.value[1] + W.value[4] * V.value[4] + W.value[7] * V.value[7];
        R.value[5] = W.value[2] * V.value[1] + W.value[5] * V.value[4] + W.value[8] * V.value[7];
        
        R.value[6] = W.value[0] * V.value[2] + W.value[3] * V.value[5] + W.value[6] * V.value[8];
        R.value[7] = W.value[1] * V.value[2] + W.value[4] * V.value[5] + W.value[7] * V.value[8];
        R.value[8] = W.value[2] * V.value[2] + W.value[5] * V.value[5] + W.value[8] * V.value[8];
    }
