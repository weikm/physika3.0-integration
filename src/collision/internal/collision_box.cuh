 ...
 * @date       : 2023-07-07
 * @description: device bounding box structure
 * @version    : 1.0
 */
...
typedef struct __align__(16) _bvh_node
{
    ...
    CU_FORCEINLINE __host__ __device__ const g_box& box() const
    {
        return _box;
    }
    CU_FORCEINLINE __host__ __device__ const _bvh_node* left() const
    {
        return this - _child;
    }
    CU_FORCEINLINE __host__ __device__ const _bvh_node* right() const
    {
        return this - _child + 1;
    }
    CU_FORCEINLINE __host__ __device__ int triID() const
    {
        return _child;
    }
    CU_FORCEINLINE __host__ __device__ bool isLeaf() const
    {
        return _child >= 0;
    }
}
