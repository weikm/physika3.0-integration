...
public:
    ...
    __forceinline vec3f transform(const vec3f& point) const
    {
        ...
        return point.dot3(
                   ...
                   vec3f(m_R1to0(2, 0), m_R1to0(2, 1), m_R1to0(2, 2)))
               + m_T1to0;
    }
};
...
__forceinline bool overlapping_trans_cache(const BOX<REAL>& bx0, const BOX<REAL>& bx1, const cbox2boxTrfCache& transcache, bool fulltest)
{
