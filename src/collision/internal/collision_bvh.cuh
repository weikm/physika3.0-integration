...
* the length of front <= triangle num
*/
typedef struct
{
...
* @param[in] i           index i
* @param[in] bvh_ids     pointer to bvh ids
* @param[in] bvh_boxes   pointer to bvh boxes
* @param[in] tri_boxes   pointer to triangle boxes
...
*/
inline __global__ void refit_serial_kernel(int* bvh_ids, g_box* bvh_boxes, g_box* tri_boxes, g_cone* bvh_cones, g_cone* tri_cones, int num)
{
...
* @param[in] num         numbers
*/
inline __global__ void refit_kernel(int* bvh_ids, g_box* bvh_boxes, g_box* tri_boxes, g_cone* bvh_cones, g_cone* tri_cones, int st, int num)
{
