...
public:
    ...
    __forceinline const float& x() const
    {
        return _data[0];
    }
    /**@brief Return the y value */
    __forceinline const float& y() const
    {
        return _data[1];
    }
    /**@brief Return the z value */
    __forceinline const float& z() const
    {
        return _data[2];
    }
    /**@brief Return the w value */
    __forceinline const float& w() const
    {
        return _data[3];
    }
    ...
    {
        return _data[0] * q._data[0] + _data[1] * q._data[1] + _data[2] * _data[2] + _data[3] * q._data[3];
    }
