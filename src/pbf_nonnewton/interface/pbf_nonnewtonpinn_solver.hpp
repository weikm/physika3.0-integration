...
#ifndef PHYSIKA_PBF_NONNEWTONPINN_SOLVER_HPP
#define PHYSIKA_PBF_NONNEWTONPINN_SOLVER_HPP
...
struct NonNewtonFluidComponentpinn;

class PBFNonNewtonpinnSolver : public Solver
{
public:
    struct SolverConfig
    {
     ...
     *        If the object contains granular Componentpinns, it is defined as applicable.
     *
...
struct NonNewtonFluidComponentpinn
{
     ...
     */
    NonNewtonFluidComponentpinn(SimMaterial material);

    /**
     * @brief default construction function of NNComponent
     */
    NonNewtonFluidComponentpinn() = default;
    ...
    *
     ...
     */
    SimMaterial getMaterial2() const;

    /**
     * @brief get total particle num of the component
     */
    uint32_t getParticleNum2() const;
...
#endif  // PHYSIKA_PBF_NONNEWTONPINN_SOLVER_HPP
