...
int main() {
    ...
    float3 lb0 = make_float3(-5.f, 0.f, -5.f);
    float3 rt0 = make_float3(5.f, 2.f, 5.f);
    float3 lb1  = make_float3(-1.f, -9.9f, -1.f);
    float3 rt1  = make_float3(1.f, -2.f, 1.f);
    ...
    // set demo
    //obj_a->getComponent<ElasticComponent>()->demo4();
    obj_a->getComponent<ElasticComponent>()->addInstance(PARTICLE_PHASE::SOLID, radius, lb0, rt0);
    obj_a->getComponent<ElasticComponent>()->addInstance(PARTICLE_PHASE::RIGID, radius, lb1, rt1);
    ...
    elastic_solver->setYoungModules(500);
    elastic_solver->setPossionRatio(0.2);
    elastic_solver->setWriteToPly(true);
    elastic_solver->setAnisotropy(make_float3(1, 1, 0.17));
