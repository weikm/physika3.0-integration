 ...
 * @date       : 2023-11-17
 * @description: Solidify Sample of Solid-liquid phase change simulation
 * @version    : 1.0
 */
...
int main()
{
    ...
    init_pos = generate_cube({ -14, 0, 0 }, { 20, 26, 20 }, 0.3);
    component->addInstance(0.3, init_pos, static_cast<int>(SLPCPhase::FLUID), 22.f);

    init_pos = generate_cube({10, 0, 0 }, {20, 20, 20 }, 0.3);
    component->addInstance(0.3, init_pos, static_cast<int>(SLPCPhase::SOLID), -200.f);
    ...
    solid_liquid_phase_change_solver->setWorldBoundary(-14, 0, 0, 30, 30, 20);
