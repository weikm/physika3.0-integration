...
SegPoints(REAL3 &VEC, 
	REAL3 &X, REAL3 &Y, // closest points
	const REAL3 &P, const REAL3 &A, // seg 1 origin, vector
	const REAL3 &Q, const REAL3 &B) // seg 2 origin, vector
{
	REAL3 T, TMP;
...
CU_FORCEINLINE __host__ __device__ REAL
TriDistPQP(REAL3 &P, REAL3 &Q, const REAL3 S[3], const REAL3 T[3])
{
...
triDist(
	...
	const REAL3& Q1, const REAL3& Q2, const REAL3& Q3,
	REAL3 &rP, REAL3 &rQ)
{
	REAL3 S[3];
	REAL3 T[3];
...
CU_FORCEINLINE __host__ __device__ REAL
anlysMinDistBoxBox(const g_box& box1, const g_box& box2)
{
	REAL3 u1 = box1.minV() - box2.maxV();
	REAL3 v1 = box2.minV() - box1.maxV();
...
CU_FORCEINLINE __host__ __device__ REAL
boxDist(const g_box& a, const g_box& b)
{
