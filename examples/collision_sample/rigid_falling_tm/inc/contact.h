...
public:
	...
	__forceinline const crigid * getBody0() const { return m_body0; }
	__forceinline const cplane* getPlane() const { return m_plane; }
	__forceinline const crigid* getBody1() const { return m_body1; }
